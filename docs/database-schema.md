...
## Tổng quan
Database được thiết kế cho hệ thống thi trực tuyến Tin học với 3 vai trò chính: Admin, Teacher, Student.

**Lưu ý:** 
- Hệ thống chỉ phục vụ cho môn Tin học
- Mỗi đề thi luôn có 50 câu hỏi, mỗi câu chiếm 0.2 điểm (tổng 10 điểm)
...
### 6. Exam_Topics (Chủ đề trong đề thi)
...
### 7. Exam_Questions (Câu hỏi trong đề thi)
...
### 8. Student_Exams (Bài thi của học sinh)
...
### 9. Student_Answers (Câu trả lời của học sinh)
